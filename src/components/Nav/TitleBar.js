            ...
            <div className="relative flex justify-between">
                <div className="z-10">
                    {this.props.back && (
                        ...
                        className="flex items-center text-lg w-full border-2 border-gray-500 text-gray-500 font-semibold focus:outline-none rounded-lg pr-3 pl-1 py-2">
                ...
                <div className="z-10">
                    {this.props.next && (
                        ...
                        className="flex justify-end items-center text-lg w-full border-2 border-green-600 text-green-600 font-semibold focus:outline-none rounded-lg pl-3 pr-1 py-2">
